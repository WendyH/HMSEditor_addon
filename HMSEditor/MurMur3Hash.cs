...
namespace FastColoredTextBoxNS {
    ...
    public sealed class Murmur3 {
        ...
        public static string StringHash(string text) {
            return ByteArrayToString(ComputeHashx86_128Impl(Encoding.ASCII.GetBytes(text)));
        }

        public static string KnuthHash(string text) {
            return BitConverter.ToString(BitConverter.GetBytes(CalculateKnuthHash(text))).Replace("-", "");
        }
