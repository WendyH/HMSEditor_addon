...
namespace HmsAddons {
	...
	public interface IHmsScriptFrame {
		...
		uint CompileScript(ref object aScriptName, ref object aScriptText, ref object aErrorMessage, ref int aErrorLine, ref int aErrorChar, ref bool aResult);

		uint GenerateScriptDescriptions(ref object aXMLDescriptions);

		uint GetCurrentState(ref bool aRunning, ref int aCurrentSourceLine, ref int aCurrentSourceChar);
